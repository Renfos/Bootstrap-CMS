...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb83d837d01_tree')) { function _lbb83d837d01_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba4318bf924_content')) { function _lba4318bf924_content($_l, $_args) { extract($_args)
?><div id="content">
